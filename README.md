...
✏️ [Шпаргалка по ES6 (2015)](#ES6)

✏️ [Шпаргалка по THIS](#THIS)
...
📖 [Набор инструментов Vanilla JS](https://vanillajstoolkit.com/reference/#distances) [**EN**] - Краткий справочник по часто используемым методам JavaScript и API браузера.
 
📖 [Список рекомендаций по вёрстке БЭМ](https://dmitriy-8-kireev.github.io/Frontend_information-master/) [**RU**] 

📖 [Учебники, задачники, справочники по web языкам](http://code.mu/) [**RU**] -Основной "фишкой" сайта являются уникальные задачники по WEB языкам с примерами решения задач и ответами. К этим задачникам написаны соответствующие учебники, справочники и тесты знаний.
...
<a name="REACT"></a> 
# REACT 
![react](https://user-images.githubusercontent.com/35109743/75464400-0f432a00-597f-11ea-991b-1fc1f3496a26.gif)
...
## VR и AR
📖 [Создание приложений дополненной реальности с React-Native](https://marmelab.com/blog/2019/04/25/react-native-augmented-reality.html) [EN].   

📖 [Документация ViroReact](https://docs.viromedia.com/docs) [EN].  
